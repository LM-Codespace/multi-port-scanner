...
<body>
    ...
    <div class="main-content">
        ...
        <form action="run_checker.php" method="post" enctype="multipart/form-data" id="checker-form" class="form">
            <div class="form-group">
                <label for="proxy_file">Proxy List File (ip:port format):</label>
                <input type="file" name="proxy_file" id="proxy_file" required accept=".txt,.csv">
            ...
            <button type="submit" class="btn">Check Proxies</button>
        </form>
